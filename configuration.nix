...
#    cloudflared
  ...
  networking.firewall.allowedTCPPorts = [ 2222 80 443 9000 ];
  networking.firewall.allowedUDPPorts = [ 41641 7844 2408 500 1701 4500 51820 config.services.tailscale.port ];
